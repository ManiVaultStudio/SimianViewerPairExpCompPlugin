...
class SimianViewerPairExpCompPluginConan(ConanFile):
    """Class to package SimianViewerPairExpCompPlugin plugin using conan
    ...
    topics = ("hdps", "ManiVault", "plugin", "SimianViewerPairExpCompPlugin", "data visualization")
    url = "https://github.com/ManiVaultStudio/SimianViewerPairExpCompPlugin"
